...
@section('content')
    <!-- Hero section -->
    <div class="owl-carousel owl-dots-overlay owl-nav-overlay owl-loaded owl-drag" data-owl-items="1"
                ...
                <div class="container text-center">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                            ...
                            <a class="button button-lg button-outline-white-2 button-border-2 mt-3"
                               href="/catalog/dlia-gladilnyx">Посмотреть все</a>
                        </div>
                    </div><!-- end row -->
                </div><!-- end container -->
            </div>
                ...
                <div class="container text-center">
                    <div class="row">
                        <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                            ...
                            <a class="button button-lg button-outline-white-2 button-border-2 mt-3" href="/catalog/etc">Посмотреть
                                все</a>
                        </div>
                    </div><!-- end row -->
                </div><!-- end container -->
    ...
    <div class="section-lg">
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-12 col-md-4">
                    <div class="product-box">
                        ...
                        <div class="product-title">
                            <h6 class="fw-medium"><a href="/catalog/sprey/154">Спрей пятновыводитель</a></h6>
                ...
                <div class="col-12 col-md-4">
                    <div class="product-box">
                        ...
                        <div class="product-title">
                            <h6 class="fw-medium">
                                <a href="/catalog/etc/143">Рулетка singeruz большая</a>
                            </h6>
                            <div class="add-to-wishlist">
                                <a href="#"><i class="far fa-heart"></i></a>
                            </div>
                ...
                <div class="col-12 col-md-4">
                    <div class="product-box">
                        ...
                        <div class="product-title">
                            <h6 class="fw-medium"><a href="/catalog/kartridzi/54">Жилки для крепления бирок</a></h6>
                            <div class="add-to-wishlist">
                                <a href="#"><i class="far fa-heart"></i></a>
                            </div>
                        </div>
            ...
            <div class="text-center mt-5">
                <a class="button button-lg button-dark button-rounded" href="/catalog">Посмотреть больше</a>
            </div>
        </div><!-- end container -->
    </div>
    <!-- end New Arrivals -->
        ...
        <div class="row g-2">
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fancy-box-3">
                    ...
                    <div class="hover-content">
                        <a class="button button-lg button-outline-white-2" href="/catalog/bumaga">Посмотреть все</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fancy-box-3">
                    ...
                    <div class="hover-content">
                        <a class="button button-lg button-outline-white-2" href="/catalog/dlia-gladilnyx">Посмотреть
                            все</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fancy-box-3">
                    ...
                    <div class="hover-content">
                        <a class="button button-lg button-outline-white-2" href="/catalog/komplekt">Посмотреть все</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fancy-box-3">
                    ...
                    <div class="hover-content">
                        <a class="button button-lg button-outline-white-2" href="/catalog/igly">Посмотреть все</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fancy-box-3">
                    ...
                    <div class="content">
                        ...
                        <p>Для машин с игольным продвижением, с нижним продвижением, с тройным продвижением и с шагающей
                            лапкой</p>
                    </div>
                    <div class="hover-content">
                        <a class="button button-lg button-outline-white-2" href="/catalog/lapki">Посмотреть все</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fancy-box-3">
                    ...
                    <div class="content">
                        ...
                        <p>Для подрезки нитей, вспарывания, прорезания петель, выполнения надсечек и других мелких
                            работ</p>
                    </div>
                    <div class="hover-content">
                        <a class="button button-lg button-outline-white-2" href="/catalog/nojnici">Посмотреть все</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fancy-box-3">
                    ...
                    <div class="hover-content">
                        <a class="button button-lg button-outline-white-2" href="/catalog/okant">Посмотреть все</a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-3">
                <div class="fancy-box-3">
                    ...
                    <div class="hover-content">
                        <a class="button button-lg button-outline-white-2" href="/catalog/sprey">Посмотреть все</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                        ...
                        <p>Материалы, которые обладают высокой степенью сопротивления износу.
                            Износостойкая продукция разрабатывается и производится с целью увеличения срока службы и
                            устойчивости к износу.
                            Продукция имеет специальную структуру и состав, которые обеспечивают высокую степень
                            износостойкости.</p>
                    </div>
                </div><!-- end row -->
            </div>
            <div class="owl-carousel" data-owl-nav="true" data-owl-dots="false" data-owl-margin="24" data-owl-xs="1"
                 data-owl-sm="2" data-owl-md="3" data-owl-lg="3" data-owl-xl="3">
                <!-- Carousel Item 1 -->
                <div class="product-box">
                    <div class="product-img">
                        <a href="/catalog/plastina/216">
                    ...
                    <div class="product-title">
                        <h6 class="fw-medium">
                            <a href="/catalog/plastina/216">Пластина 257033B56</a></h6>
                        <div class="add-to-wishlist">
                            <a href="#"><i class="far fa-heart"></i></a>
                        </div>
                    </div>
                ...
                <div class="product-box">
                    ...
                    <div class="product-title">
                        <h6 class="fw-medium">
                            <a href="/catalog/lapki/204">Лапка 257321-5.6</a>
                        </h6>
                        <div class="add-to-wishlist">
                            <a href="#"><i class="far fa-heart"></i></a>
                        </div>
                ...
                <div class="product-box">
                    ...
                    <div class="product-title">
                        <h6 class="fw-medium">
                            <a href="/catalog/komplekt/198">Комплект Pegasus W562</a></h6>
                        <div class="add-to-wishlist">
                            <a href="#"><i class="far fa-heart"></i></a>
                        </div>
                    </div>
